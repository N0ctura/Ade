                ...
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-neutral-400 mt-1 max-w-xl">
                      Benvenuto nel pannello di controllo ufficiale di <strong>AdeBot</strong>. Gestisci la grafica dei canali, i messaggi temporizzati e le funzioni interattive del server in tempo reale.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-[#2b2d31] border border-neutral-800 rounded-xl overflow-hidden shadow-lg lg:col-span-2">
                  ...
                  <div className="p-6 space-y-4">
                    <p className="text-xs text-neutral-400 leading-relaxed">
                      Il codice sorgente di AdeBot è sincronizzato tramite GitHub Actions o buildpack nativi di Railway. Tutte le modifiche apportate a questa dashboard aggiornano all'istante le risposte del bot sul server Discord.
                    </p>
